...
And then include `opencl.h` as follows:

```c
// main.c
#include "node_modules/opencl.c/CL/opencl.h"
...
If you add the path `node_modules/opencl.c` to your compiler's include paths.

```bash
$ clang -I./node_modules/opencl.c main.c  # or, use gcc
$ gcc   -I./node_modules/opencl.c main.c
```
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/KhronosGroup/OpenCL-Headers)
[![ORG](https://img.shields.io/badge/org-nodef-green?logo=Org)](https://nodef.github.io)
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/opencl.c)
